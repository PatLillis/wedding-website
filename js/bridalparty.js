$(document).on('ready', function () {
    var weddingparty = {
        megan: {
            ...
            headerType: 'bridesmaid-header'
        },
        emily: {
            element: $('.bridesmaid-2'),
            title: 'Emily Kallenberg',
        ...
        pat: {
            ...
            subtitle: 'Best Man',
            headerType: 'groomsman-header'
        },
        jojo: {
            element: $('.groomsman-2'),
            title: 'Steven Alrichs',
    ...
    function setUpPopover(partyOption) {
        var template = {
            template: '<div class="popover party-popover" role="tooltip"><div class="arrow"></div><h1 class="popover-title ' + partyOption.headerType + '"></h1><h3 class="popover-subtitle text-muted ' + partyOption.headerType + '">' + partyOption.subtitle + '</h3><div class="popover-content"></div></div>'
        };
