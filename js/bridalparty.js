$(document).on('ready', function () {
    ...
    function setUpPopover(partyOption) {
        var template = {
            template: '<div class="popover party-popover" role="tooltip"><div class="arrow"></div><h1 class="popover-title"></h1><h3 class="popover-subtitle text-muted">' + partyOption.subtitle + '</h3><div class="popover-content"></div></div>'
        };
